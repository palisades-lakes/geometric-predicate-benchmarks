...
public final class TotalSum {
  ...
  public static final void main (final String[] args) {
    ...
    for (int i=0;i<trys;i++) {
      ...
      gep.java.numbers.BigFloat b = gep.java.numbers.BigFloat.ZERO;
      //gep.java.numbers.BigFloat0 f = gep.java.numbers.BigFloat0.ZERO;
  ...
  //      gep.jmh.accumulators.BigFloatAccumulator0.make();
