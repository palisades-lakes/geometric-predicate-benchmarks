package gep.java.benchmarks.arithmetic;

import gep.java.algebra.OneSetOneOperation;
import gep.java.algebra.OneSetTwoOperations;
import gep.java.algebra.Set;
import gep.java.numbers.BoundedNatural;
import gep.java.prng.Generator;
import gep.java.prng.GeneratorBase;
 ...
 * @version 2026-08-21
 */
@SuppressWarnings({"unchecked","unused","static-method"})
public final class   Naturals implements Set {
  ...
  divideAndRemainder (final BoundedNatural x0,
    ...
    return x0.divideAndRemainder(x1); }
