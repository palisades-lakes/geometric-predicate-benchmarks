package gep.java.benchmarks.tetrahedra;

import gep.java.geometry.Generators;
import gep.java.geometry.tetrahedron.BigFloatTetrahedron3D;
import gep.java.geometry.tetrahedron.RationalFloatTetrahedron3D;
import gep.java.geometry.tetrahedron.Tetrahedron3D;
import gep.java.geometry.tetrahedron.TetrahedronVector3D;
import gep.java.geometry.tetrahedron.macro.AdaptMacro;
import gep.java.geometry.tetrahedron.macro.DefaultMacro;
import gep.java.geometry.tetrahedron.macro.ExactMacro;
import gep.java.geometry.tetrahedron.macro.FastMacro;
import gep.java.geometry.tetrahedron.macro.SlowMacro;
import gep.java.geometry.tetrahedron.shewchuk.Adapt;
import gep.java.geometry.tetrahedron.shewchuk.Exact;
import gep.java.geometry.tetrahedron.shewchuk.Fast;
import gep.java.geometry.tetrahedron.shewchuk.Slow;
